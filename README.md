...
- Created a microservice oriented architecture (TDD Python based) for GIS services (All those services run testsuits with Github actions CI) Here is the <a href="https://github.com/pygis-backend">Organization's page </a> that I created for all those services. And here is each link to each service : <br/>
